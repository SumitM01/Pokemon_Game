...
canvas.width = 1024
canvas.height = 576
//defining battlescore
// var battleScore = "{{player.score}}"
// document.querySelector('input[id="score"]').value = battleScore
...
//   c.font = '30px Arial'
//   c.strokeWidth = 4
//   c.fillText(`Score: ${battleScore}`, canvas.width - 200, 200)
//   c.stroke()
//   c.fill()
// }
...
image.src = '/static/img/Pellet Town.png'
...
function animate() 
{
  //battle score updation
  // var x = document.querySelector('input[id="score"]');
  // x.value = battleScore;
  document.querySelector('input[id="score"]').value = battleScore
